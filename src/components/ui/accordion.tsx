...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="transition-all duration-300 ease-in-out data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down overflow-hidden text-sm"
      {...props}
    >
